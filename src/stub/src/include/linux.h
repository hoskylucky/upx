        ...
        if (Z1(__NR_##name)) {                                                                     \
            if (Z0(arg1) && Z0(arg2)) {                                                            \
                __asm__ __volatile__(                                                              \
                    "xorl %%ecx,%%ecx; xorl %%ebx,%%ebx; push %[sysN]; popl %0; int $0x80"         \
                    : "=a"(__res)                                                                  \
                    : [sysN] "g"(__NR_##name)                                                      \
                    : "ebx", "ecx");                                                               \
            } else if (Z0(arg1) && Z1(arg2)) {                                                     \
                __asm__ __volatile__(                                                              \
                    "push %[a2]; popl %%ecx; xorl %%ebx,%%ebx; push %[sysN]; popl %0; int $0x80"   \
                    : "=a"(__res)                                                                  \
                    : [sysN] "g"(__NR_##name), [a2] "g"((long) (arg2))                             \
                    : "ebx", "ecx");                                                               \
            } else if (Z1(arg1) && Z0(arg2)) {                                                     \
                __asm__ __volatile__(                                                              \
                    "xorl %%ecx,%%ecx; push %[a1]; popl %%ebx; push %[sysN]; popl %0; int $0x80"   \
                    : "=a"(__res)                                                                  \
                    : [sysN] "g"(__NR_##name), [a1] "g"((long) (arg1))                             \
                    : "ebx", "ecx");                                                               \
            } else if (Z1(arg1) && Z1(arg2)) {                                                     \
                __asm__ __volatile__(                                                              \
                    "push %[a2]; popl %%ecx; push %[a1]; popl %%ebx; push %[sysN]; popl %0; int "  \
                    "$0x80"                                                                        \
                    : "=a"(__res)                                                                  \
...
static inline _syscall2(
    int, access, const char *, file, int,
    mode) static inline _syscall1(int, adjtimex,
                                  struct timex *, ntx) static inline _syscall1(void *, brk, void *, high) static inline _syscall1(int, close, int, fd) static inline _syscall3(int, execve, const char *, file, char **, argv, char **, envp) static inline _syscall1noreturn(_exit, int, exitcode) static inline _syscall3(int,
                                                                                                                                                                                                                                                                                                                            fcntl,
                                                                                                                                                                                                                                                                                                                            int, fd, int, cmd,
                                                                                                                                                                                                                                                                                                                            long,
                                                                                                                                                                                                                                                                                                                            arg) static inline _syscall0(pid_t, fork) static inline _syscall2(int,
                                                                                                                                                                                                                                                                                                                                                                                              ftruncate, int, fd, size_t, len) static inline _syscall0(pid_t,
                                                                                                                                                                                                                                                                                                                                                                                                                                                       getpid) static inline _syscall2(int,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       gettimeofday,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       struct timeval *, tv, void *, tz) static inline _syscall3(off_t,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 lseek,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 int,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 fd,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 off_t,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 offset,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 int, whence) static inline _syscall2(int,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      memfd_create,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      char const
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          *,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      name,
...
static inline _syscall3(int, mprotect,
                        void *, addr, size_t, len, int, prot) static inline _syscall3(int, msync,
                                                                                      void const *,
                                                                                      addr, size_t,
                                                                                      len,
                                                                                      unsigned, flags) static inline _syscall2(int, munmap, void *, start, size_t, length) static inline _syscall2(int, nanosleep, const struct timespec *, rqtp, struct timespec *, rmtp) static inline _syscall3(int,
                                                                                                                                                                                                                                                                                                   open,
                                                                                                                                                                                                                                                                                                   const char
                                                                                                                                                                                                                                                                                                       *,
                                                                                                                                                                                                                                                                                                   file,
                                                                                                                                                                                                                                                                                                   int, flag, int, mode) static inline _syscall3(ssize_t,
                                                                                                                                                                                                                                                                                                                                                 read,
                                                                                                                                                                                                                                                                                                                                                 int, fd, void *, buf, size_t, count) static inline _syscall2(int, stat, char const *, path, struct stat *, buf) static inline _syscall3(pid_t,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         waitpid, pid_t, pid, int *, wait_stat, int, options) static inline _syscall3(ssize_t,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      write, int, fd, const void *, buf, size_t, count) static inline _syscall1(int,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                uname,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                struct utsname *, buf) static inline _syscall1(int, unlink, const char *, file) static inline _syscall2(int,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        link,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        const char
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            *,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        src,
...
#define __NR_read (3 + 4000)
    ...
    __asm__ __volatile__("bal sysgo_incl" : "+r"(v0) : "r"(a0), "r"(a1), "r"(a2) : "a3", "ra");
    return v0;
}
#endif /* NO_WANT_READ }*/
...
#define __NR_close (6 + 4000)
    ...
    __asm__ __volatile__("bal sysgo_incl" : "+r"(v0) : "r"(a0) : "a3", "ra");
    return v0;
}
#endif /* NO_WANT_CLOSE }*/
